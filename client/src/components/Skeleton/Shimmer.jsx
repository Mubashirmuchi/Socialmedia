...
const Shimmer = () => {
    return (
        <>
            <div
                role="status"
                className="w-[883px]  border-gray-200  shadow animate-pulse    bg-white  rounded-lg my-6 pb-4"
            >
                {" "}
                <div className="flex items-center   px-2 py-3 mx-3">
                    <svg
                ...
                <div className="flex h-[500px] items-center justify-center mb-4 bg-gray-300 rounded dark:bg-gray-400">
                    <svg
